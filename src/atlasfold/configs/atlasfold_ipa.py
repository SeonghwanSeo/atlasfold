from atlasfold.model import model_ipa as model

monomer_ipa_config = model.AtlasFoldIPAConfig(
    name="atlasfold-ipa",
    lm_name="atlaslm-3b",
    channel_s=384,
    channel_s_lm=768,
...
# Match the conventional preset name used by the existing monomer config.
monomer_config = monomer_ipa_config
