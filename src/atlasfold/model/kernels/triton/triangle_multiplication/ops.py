...
def precompute(
    ...
    Folding the affine into BF16/FP16 weights changes the projection and makes
    mean subtraction unstable for shifted inputs. Normalize before the dot
    products instead, keeping the normalization inside the fused kernels.
    """
    return {
